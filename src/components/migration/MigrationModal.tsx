        ...
        <div className="p-8">
          {step === 'detect' && (
            <div className="flex flex-col items-center text-center py-8">
              ...
              <p className="text-gray-600 dark:text-gray-400 font-medium">Мағлыўматлар тексерилмекте...</p>
            </div>
          )}
          ...
          {step === 'locked' && (
            <div className="flex flex-col items-center text-center py-6">
              ...
              <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-2">Блокқа түсти</h3>
          ...
          {step === 'success' && (
            <div className="flex flex-col items-center text-center py-6">
              ...
              <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Сәтті аяқланды!</h3>
